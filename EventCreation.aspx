    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="txtTitle" runat="server" MaxLength="100" placeholder="Enter event title" />
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtLocation" runat="server" MaxLength="150" placeholder="Event location" />
                </div>
            </div>

            <asp:Button ID="btnCreateEvent" runat="server" Text="🎉 Create Event" CssClass="btn-create" OnClick="btnCreateEvent_Click" />
