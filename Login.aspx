    ...
    <form id="form1" runat="server" autocomplete="off">
        <div class="login-container" role="main" aria-label="Login Form">
            <div class="header-section">
                ...
                <h2>Welcome Back</h2>
                <p class="subtitle">Sign in to your EventMate account</p>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <asp:TextBox ID="txtUsername" runat="server" autocomplete="username" placeholder="Enter your username" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    <span class="input-icon">🔒</span>
                    <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" autocomplete="current-password" placeholder="Enter your password" />
                </div>
            </div>
            ...
            <asp:Button ID="btnGoToRegister" runat="server" Text="Create Account" CssClass="btn-register" OnClick="btnGoToRegister_Click" />
